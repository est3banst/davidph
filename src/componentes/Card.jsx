    ...
    return (
      ...
      >
        <div
          ...
          className="absolute top-0 left-0 bg-[length:100%_50%] md:bg-[length:100%_80%] right-0 bottom-0 h-[calc(110vh+1rem)] w-[110vw] md:h-[calc(100vh+2rem)] md:w-[calc(120vw+2rem)] transition-transform duration-300 group-hover:scale-120"
        ></div>
